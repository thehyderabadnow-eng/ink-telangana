...
export default function NotFound() {
  return (
    <div className="flex-grow flex flex-col items-center justify-center text-center px-4 py-32 animate-in fade-in duration-500">
      <h2 className={`text-5xl font-serif font-bold ${brandClasses.textGold} mb-4`}>
        404
      </h2>
      ...
      <Link 
        href="/" 
        className={`px-8 py-3 rounded-full ${brandClasses.bgGold} ${brandClasses.textNavy} font-bold hover:bg-yellow-500 transition-colors shadow-lg`}
      >
        Return to Home
      </Link>
    </div>
