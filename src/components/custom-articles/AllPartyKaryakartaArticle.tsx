                        ...
                        <div className="text-base md:text-lg text-gray-800 leading-loose">
                            ...
                            <div className="space-y-6 text-gray-800 mb-10">
                                ...
                                <p className="font-medium text-red-800 bg-red-50 p-4 rounded-lg">
                                    పంట చేతికి వచ్చిన తర్వాత దుక్కి దున్నిన ఎడ్లకు మేత పెట్టకుండా, సంతకు పోయి బలిసిన ఎడ్లను బేరం చేసుకుని కొనుక్కొచ్చుకున్నట్టు.. నాయకులు గెలిచిన తర్వాత.. ఏళ్లతరబడి పోరాడి అలసిన కార్యకర్తలను పనికిరావని చెప్పి పక్కన పెట్టి, వేరే పార్టీలో అధికారాన్ని హాయిగా ఆస్వాదించి, ప్రజాధనాన్ని దోచుకున్న నాయకులను తీసుకొచ్చి, మా పక్కన కూర్చోపెట్టి, వాళ్ళకి పదవులు ఇచ్చి, మమ్మల్ని అవమానించి, ఆగం చేసి పార్టీకి దూరం చేస్తున్నారు. ఇదేనా మీరు కార్యకర్తలకు చేసే న్యాయం? ఇదేనా మీ పార్టీలు కార్యకర్తలకు ఇచ్చే మర్యాద? అంటూ ఆగ్రహానికి గురవుతున్నారు.
                                </p>
                            </div>

                            <blockquote className="p-6 rounded-xl font-serif text-lg mb-10 shadow-lg border-l-4 border-red-600">
                                "సమయం వచ్చినప్పుడు కార్యకర్తల సత్తా ఏంటో చూపిస్తాం, మీ అధికార గర్వాన్ని, అహంకారాన్ని అణగదొక్కుతాం. మేము మీవల్ల లాభపడింది ఏం లేదు. ఎలాగూ నష్టపోయాం, ఇంకా నష్టపోయేదేం లేదు. నిఖార్సైన కార్యకర్తలను దూరం పెట్టి, వలసవాదులతో కలిసి ఎలా గెలుస్తారో చూస్తాం. మీకు అధికారం దూరమైతే, ఓటమితో ఒంటరైతే అప్పుడైనా కార్యకర్తల విలువ తెలుస్తుంది."
                            </blockquote>

                            <p className="mb-10">
                                చివరి వరకు పార్టీలో ఉండేదెవరు, మీరు ఓడిపోయిన వెంటనే పార్టీ మారేది ఎవరో తెలుస్తుందని వారి అభిప్రాయం వ్యక్తపరుస్తున్నారు. పార్టీని గెలిపించి తాను ఓడిపోతూ కూడా, ఇంకా ఆ జెండానే పట్టుకుంటూ తన గుర్తింపు కోసం ఎదురుచూస్తున్నాడు. అధికార పార్టీ అసంతృప్త కార్యకర్తలను అక్కున చేర్చుకుని బలం పెంచుకునేందుకు  ప్రతిపక్ష పార్టీలకు మంచి అవకాశంగా మారుతుంది.
                            </p>
                            <blockquote className="p-6 rounded-xl font-serif text-lg mb-10 shadow-lg border-l-4 border-red-600">
