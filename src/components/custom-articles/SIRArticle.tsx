      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <article className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden mt-4">
          ...
          <div className="w-full h-64 sm:h-72 md:h-[28rem] relative bg-gray-200">
            <img
              src="https://blogger.googleusercontent.com/img/a/AVvXsEiE-gEobpP9eWZSj0g8FzKCIJmPQECrRjhQXVR1x-5lOi6nnlw3yO3uJYna1yzErbFAU6NKNwPzfwvoxoFJnGDJSQ3r7xozWcagNzvaP86MRR3nD1d3ELoLA95045CyQgJ7B8Ap96c0L0QAJ4MFBfb57U-MnNjVfHkkOaToxYn_AM5ARa579UZcH9smlR3_"
          ...
          <ReadOnlyWrapper className="p-5 md:p-10">
            <div className="text-base md:text-lg text-gray-800 leading-loose">
              ...
              <blockquote className="relative p-6 md:p-8 bg-gray-50 rounded-xl border-l-4 border-[#0B1B35] mb-8 font-serif text-lg md:text-xl text-gray-800 shadow-sm">
                ఓటు హక్కు అనేది ప్రజాస్వామ్యంలో మనకు ఉన్న అత్యంత బలమైన ఆయుధం. మన ఓటును సురక్షితంగా ఉంచుకోవడం మన బాధ్యత. నిర్లక్ష్యం చేయకుండా, నిబంధనలు పాటించి పారదర్శకమైన ఓటరు జాబితా రూపకల్పనలో ప్రతి ఒక్కరూ భాగస్వాములవుదాం.
              </blockquote>
