                        ...
                        <div className="text-base md:text-lg text-gray-800 leading-loose">
                            ...
                            <div className="bg-gradient-to-br from-teal-50 to-emerald-50 border-2 border-teal-200 p-6 rounded-2xl mb-10 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm md:text-base">
                                    ...
                                    {/* Left Column: Baby Photo & Bank Details */}
                                    <div className="flex flex-col gap-4">

                                        {/* Baby Photo */}
                                        <img
                                            src="https://blogger.googleusercontent.com/img/a/AVvXsEj3TjnTAEl--j1UswT6BARkXpglC11T-d0E2c5vLGsveS0l1L791lY8SXuOZKIhdUd1Ca5suM3nQOupJgR-5F5YLkX-7a4dYmfcTdy3B08vzMDgzN71pz-VcN2uqSrGLqLgOZjzED85j9--vQuYC_qfBKM9-R7eKxgb2OAOM1_1nJ7Tufvv82_myoRZxpAc"
                                            alt="Baby Naveen Kumar Reddy"
                                            className="w-full h-60 sm:h-67 object-cover rounded-xl border border-teal-200 shadow-sm"
                                        />

                                        {/* Bank Details Section */}
                                        <div className="flex flex-col justify-center bg-white/60 p-5 rounded-xl border border-teal-100">
                                            <div className="space-y-3 text-gray-800 w-full text-left">
                                                <p className="border-b border-teal-100 pb-2"><strong>Father Name:</strong> Naveen Kumar Reddy.R</p>
                                                <p className="border-b border-teal-100 pb-2"><strong>Bank Name:</strong> SBI Bank</p>
                                                <p className="border-b border-teal-100 pb-2"><strong>A/C Number:</strong> 30830783425</p>
                                    ...
                                    {/* Milaap Link & QR Code Section */}
                                    <div className="bg-white p-5 rounded-xl border border-teal-100 flex flex-col items-center text-center justify-center">
                                        <p className="text-gray-700 italic font-medium mb-4 text-sm">
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center underline justify-center w-full bg-teal-600 text-white font-bold py-3 px-4 rounded-xl hover:bg-teal-700 transition-colors text-center text-sm md:text-base shadow-sm mb-4"
                                        >
                                        ...
                                        <div className="flex flex-col items-center">
                                            <img
                                                src="https://blogger.googleusercontent.com/img/a/AVvXsEge2v9_cW_QFSS3d020pqc7mEy8r65_uEFU1s39p3kudzJLVYsGOGPrJWImXEm0unv6TuHwFNZgPHbC1UOx6C7mIgafDEsm57CAzg6DWHcBEiLgjCDdqzVIZFbbStZjgr70oHTt7S4qRizR_YeESDFz3VrELbXL4U3hlam1wBGi9J8pLqYi-n55ms3RGEcI"
                                                alt="Milaap QR Code"
                                                className="w-35 h-36 sm:w-35 sm:h-36 object-contain border-2 border-teal-100 rounded-xl p-1 shadow-sm"
                                            />
                                            <span className="text-[10px] font-bold text-teal-800 mt-2 uppercase tracking-wider bg-teal-50 px-2 py-1 rounded-md">
                                                Milaap QR Code
                                            </span>
                                        </div>
                                ...
                                <p className="mt-6 text-xs md:text-sm text-gray-600 text-center font-medium">
